...
public class SetSystemTimePage extends NavigationPage {
    ...
    public SetSystemTimePage validateAuthPacNameMessage(String expectedValue) throws InterruptedException {
        ActOn.wait(driver, AUT_PACK_NAME_MESSAGE);
        Thread.sleep(7000);
    ...
    public SetSystemTimePage validateDeAuthPacNameMessage(String expectedValue) throws InterruptedException {
        ActOn.wait(driver, DEAUTE_PACK_NAME_MESSAGE);
        Thread.sleep(7000);
    ...
    public SetSystemTimePage validateResetDefaultMessage(String expectedValue) throws InterruptedException {
        ActOn.wait(driver, RESET_DEFAULT_MESSAGE);
        Thread.sleep(7000);
    ...
    public SetSystemTimePage validateTimeFormatMessage(String expectedValue) throws InterruptedException {
        ActOn.wait(driver, SET_TIME_MESSAGE);
        Thread.sleep(7000);
    ...
    public SetSystemTimePage validateCorrectTimeFormatMessage(String expectedValue) throws InterruptedException {
        ActOn.wait(driver, SET_TIME_MESSAGE);
        Thread.sleep(7000);
        String actualResponse = ActOn.element(driver, SET_TIME_MESSAGE).getTextValue();
        Assert.assertEquals(actualResponse, expectedValue);
    ...
    public SetSystemTimePage validateDownloadCancel(String expectedValue) throws InterruptedException {
        Thread.sleep(7000);
